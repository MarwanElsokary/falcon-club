...
import 'package:falconclubapp/feature/scout/ui/widget/scout_pinput_screen_with_navigation.dart';
...
import '../../../signup/ui/widget/gender_widget.dart';
import '../../../signup/ui/widget/phone_auth_text_from_field.dart';
import '../../../signup/ui/widget/show_password_icon_widget.dart';
import '../../../signup/ui/widget/upload_profile_image_widget.dart';
      ...
      builder: (context) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: _termsAndPolicies.isEmpty
                      ...
                      child: AnimateBuilder(
                        ...
                        child: TextFromFieldUtilsWidget(
                          ...
                          validator: (v) => v!.isEmpty
                              ? 'من فضلك تأكد من ادخال الاسم'.tr()
                              : null,
                          fillColor: fillColor,
              ...
              builder: (context, showValidation, _) {
                ...
                return ValueListenableBuilder<String>(
                  ...
                  builder: (context, password, _) =>
                      _buildValidationRequirements(password),
                );
              },
            ),
          ],
      ...
      child: BlocConsumer<LoginCubit, LoginState>(
        listener: (context, state) {
          if (state is registerSuccess) {
            // ← نفس flow النادي بالظبط — بس ScoutPinputScreenWithNavigation
            showCupertinoModalBottomSheet(
              ...
              builder: (c) => BlocProvider(
                ...
                child: ScoutPinputScreenWithNavigation(
                  phoneNumber: _cubit.controller.email.text,
                ),
              ),
            );
            showSuccesSnackBar(
            ...
            child: AnimatedSwitcher(
              ...
              child: state is registerLoading
                ...
                children: [
                  ...
                  // زرار التسجيل — يكال registerScout بدل registerClub
                  ButtonUtils(
                    text: 'تسجيل كشاف'.tr(),
                    onPressed: () {
                      if (!_agreedToTerms) {
                      ...
                      if (_cubit.formKey.currentState!.validate()) {
                        // ← الفرق الوحيد: registerScout بدل registerClub
                  ...
                  InkWell(
                    onTap: () => context.pushNamed(AppRoute.loginScreen),
                    child: Text.rich(
                      TextSpan(
                        children: [
                          TextSpan(
